...
The raw dataset, [polyhouse_sensors.csv](file:///c:/Users/vazeem/INTERNSHIP/mushroom-yield-project/data/raw/polyhouse_sensors.csv), contains **365 observations** representing a full year of daily readings from January 1, 2024, to December 30, 2024.

### Data Cleaning Strategy
The data pipeline was implemented in [clean.py](file:///c:/Users/vazeem/INTERNSHIP/mushroom-yield-project/src/clean.py) using the following steps:
...
The cleaned data is saved in Parquet format at [02_cleaned.parquet](file:///c:/Users/vazeem/INTERNSHIP/mushroom-yield-project/data/interim/02_cleaned.parquet) for downstream modeling.
...
#### Correlation Heatmap
![Correlation Heatmap](file:///c:/Users/vazeem/INTERNSHIP/mushroom-yield-project/reports/figures/corr_heatmap.png)

#### Scatter Plots vs Yield
![Sensor Scatter Plots](file:///c:/Users/vazeem/INTERNSHIP/mushroom-yield-project/reports/figures/scatter_yield.png)
...
To simulate real-world forecasting (where the model must predict future yield using past environmental data), we implemented a strict **chronological 80/20 train/test split** in [split_scale.py](file:///c:/Users/vazeem/INTERNSHIP/mushroom-yield-project/src/split_scale.py):
...
![Predicted vs Actual Yield](file:///c:/Users/vazeem/INTERNSHIP/mushroom-yield-project/reports/figures/pred_vs_actual.png)
...
An interactive dashboard was developed in [app.py](file:///c:/Users/vazeem/INTERNSHIP/mushroom-yield-project/app.py) for operational use by growers:
...
*   **API & Logging:** Requests are processed using the prediction module in [predict.py](file:///c:/Users/vazeem/INTERNSHIP/mushroom-yield-project/src/predict.py) and appended to [predictions.csv](file:///c:/Users/vazeem/INTERNSHIP/mushroom-yield-project/logs/predictions.csv).

### Live Cloud Deployment
*   **Platform:** Streamlit Community Cloud
*   **URL:** [https://vazeem-internship-2026-5yryfkqukyvqh9zgefpj7z.streamlit.app](https://vazeem-internship-2026-5yryfkqukyvqh9zgefpj7z.streamlit.app)
...
### Inference Logging
All production prediction requests are logged to [predictions.csv](file:///c:/Users/vazeem/INTERNSHIP/mushroom-yield-project/logs/predictions.csv). The recorded fields are:
